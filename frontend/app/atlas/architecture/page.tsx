...
export const metadata: Metadata = {
  title: "Архитектура управления | Атлас AKYL",
  description: "Схема ключевых элементов и связей системы управления МЖД.",
};
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-10">
            <div className="lg:col-span-8">
              ...
              <p className="mt-6 text-lg leading-relaxed text-slate-600">
                Связь методологии, процессов, данных и цифровых инструментов.
              </p>
            </div>
          </div>
        </Container>
