    ...
    <section className="relative overflow-hidden border-b border-slate-200/80 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white">
      ...
      <Container className="relative py-14 md:py-20 lg:py-24">
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          ...
          <div className="relative rounded-[24px] border border-white/10 bg-white/[0.06] p-6 shadow-[0_24px_80px_-30px_rgba(0,0,0,0.5)] backdrop-blur-xl md:p-8">
            ...
            <div className="mt-6 flex h-40 items-end justify-between gap-2 md:h-48">
              {previewBars.map((h, i) => (
                <div
                  key={i}
                ...
                >
                  <div
                    className="w-full max-w-[28px] rounded-t-md bg-gradient-to-t from-cyan-500/40 to-cyan-300/90 shadow-[0_0_20px_rgba(34,211,238,0.25)]"
                    style={{ height: `${h}%` }}
                  />
                </div>
              ))}
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 border-t border-white/10 pt-5 text-center">
              <div>
                ...
                <p className="mt-1 text-sm font-semibold text-white">1,29 млн</p>
              </div>
              <div>
                <p className="text-xs text-white/45">Факт</p>
                <p className="mt-1 text-sm font-semibold text-white">1,37 млн</p>
              </div>
              <div>
                <p className="text-xs text-white/45">KPI</p>
                <p className="mt-1 text-sm font-semibold text-emerald-300">0,82</p>
              </div>
            </div>
          </div>
        </div>
