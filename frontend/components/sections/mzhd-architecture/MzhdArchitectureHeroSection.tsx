...
import { mzhdArchitectureHero, mzhdArchitectureImages } from "@/data/mzhdArchitectureData";
  ...
  return (
    <section className="relative min-h-[80vh] overflow-hidden text-white">
      <div className="absolute inset-0">
        <Image
          src={mzhdArchitectureImages.hero}
          alt={mzhdArchitectureHero.imageAlt}
          fill
          priority
