...
const blocks = [
  {
    title: "Методология",
    text: "Объясняет принципы, логику и основы профессионального управления МЖД.",
  },
  {
    title: "Атлас",
    text: "Показывает архитектуру, процессы, связи и модели управления в визуальном виде.",
  },
  {
    title: "Инструменты",
      ...
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-slate-600">
            Страница инструментов должна быть связана с методологией, атласом,
            кейсами и внедрением. Тогда сайт воспринимается как целостная
