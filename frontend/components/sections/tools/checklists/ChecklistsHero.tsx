...
const highlights = [
  {
    icon: ListChecks,
    title: "5 направлений оценки",
    line: "От техники и финансов до жителей, подрядчиков и эффективности.",
  },
  {
    icon: Gauge,
    title: "Быстрый результат",
    line: "Ответы по шкале «Нет / Частично / Да» и мгновенный разбор.",
  },
  {
    icon: ClipboardCheck,
    title: "Понятные рекомендации",
    line: "Итог в процентах, статус и шаги к другим инструментам AKYL.",
  },
] as const;
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[1fr_minmax(0,380px)] lg:gap-16">
          <div>
            ...
            <h1 className="text-4xl font-bold leading-[1.1] tracking-tight text-slate-950 md:text-5xl lg:text-[3.1rem]">
              Чек-листы оценки управления МЖД
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg">
              Практический инструмент для быстрой оценки качества управления
              многоквартирным домом по ключевым направлениям.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <Button asChild>
                <Link href="#checklists-interactive">Начать оценку</Link>
              </Button>
          ...
          <aside
            aria-label="Кратко об инструменте"
            className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1"
          >
            {highlights.map(({ icon: Icon, title, line }) => (
              <div
                key={title}
