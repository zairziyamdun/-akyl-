...
import { mzhdTheoryCta } from "@/data/mzhdTheoryData";
    ...
    <section className="pb-20 sm:pb-24">
      <Container>
        <div className="rounded-3xl bg-slate-900 px-8 py-12 text-white sm:px-12">
          <h2 className="text-2xl font-semibold sm:text-3xl">{mzhdTheoryCta.title}</h2>
          <p className="mt-3 max-w-lg text-white/70">{mzhdTheoryCta.description}</p>
