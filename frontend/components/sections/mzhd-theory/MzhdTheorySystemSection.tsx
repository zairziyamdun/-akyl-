...
import { mzhdTheorySystemSteps } from "@/data/mzhdTheoryData";
    ...
    <section className="py-16 sm:py-20">
      <Container>
        ...
        <p className="mt-4 max-w-3xl text-slate-600">
          МЖД рассматривается как целостная система с входами, процессами, выходами и обратной связью.
          Управление — не набор разрозненных услуг, а непрерывный цикл улучшений.
        </p>
