          ...
          >
            ...
            <div className="mt-10 grid gap-10 border-t border-black/10 pt-8 md:grid-cols-2">
              ...
              >
                ...
                <p className="mt-5 text-[15px] leading-8 text-black/62 md:text-base">
                  {book.educationText}
                </p>
              </motion.div>
            </div>
              ...
              <div className="grid gap-8 lg:grid-cols-[1.2fr_auto] lg:items-end">
                <div className="max-w-2xl">
                  ...
                  <p className="mt-4 text-[15px] leading-8 text-black/62 md:text-base">
                    Третья книга замыкает цикл: она задаёт стандарты подготовки
                    людей так, чтобы система AKYL не оставалась теорией, а
                    устойчиво работала в организациях.
                  </p>
                </div>
