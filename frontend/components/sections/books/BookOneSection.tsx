          ...
          >
            ...
            <div className="mt-10 grid gap-10 border-t border-black/10 pt-8 md:grid-cols-2">
              ...
              >
                ...
                <div className="mt-5">
                  <Bullets items={book.whatReveals} />
                </div>
              </motion.div>
              ...
              <div className="grid gap-8 lg:grid-cols-[1.2fr_auto] lg:items-end">
                <div className="max-w-2xl">
                  ...
                  <p className="mt-4 text-[15px] leading-8 text-black/62 md:text-base">
                    Первая книга формирует основу всей системы. Она задаёт
                    управленческую логику, объясняет архитектуру модели,
                    показывает взаимосвязь ролей, процессов, KPI и цифровых
                    инструментов в профессиональном управлении МЖД.
                  </p>
                </div>
