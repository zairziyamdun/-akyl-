    ...
    >
      <Container>
        <SectionHeading
          ...
          description="Ниже — ориентиры, которые встречаются при последовательном внедрении методологии и инструментов. Конкретные значения зависят от исходного состояния и масштаба программы."
