...
import { mzhdStandardsCta } from "@/data/mzhdStandardsData";
    ...
    <section className="pb-20 sm:pb-24">
      <Container>
        <div className="relative overflow-hidden rounded-3xl bg-violet-950 px-8 py-12 text-white sm:px-12">
          ...
          <h2 className="relative text-2xl font-semibold sm:text-3xl">{mzhdStandardsCta.title}</h2>
          <p className="relative mt-3 max-w-lg text-white/70">{mzhdStandardsCta.description}</p>
