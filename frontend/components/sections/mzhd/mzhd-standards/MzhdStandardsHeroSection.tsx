...
import { mzhdStandardsHero, mzhdStandardsImages } from "@/data/mzhdStandardsData";

export function MzhdStandardsHeroSection() {
  return (
    <section className="relative min-h-[80vh] overflow-hidden text-white">
      <div className="absolute inset-0">
        <Image
          src={mzhdStandardsImages.hero}
          alt={mzhdStandardsHero.imageAlt}
          fill
          priority
