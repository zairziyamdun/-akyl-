...
import { mzhdFinanceBudgetItems } from "@/data/mzhdFinanceData";
    ...
    <section className="py-16 sm:py-20">
      <Container>
        ...
        <p className="mt-4 max-w-3xl text-slate-600">
          Годовая смета с разбивкой по статьям: содержание, ремонт, ресурсы, резерв на непредвиденные работы.
          Утверждается собранием собственников.
        </p>
