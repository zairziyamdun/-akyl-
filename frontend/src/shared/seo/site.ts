...
export const MZHD_STANDARDS_SEO = {
  title: "Принципы и стандарты управления МЖД | AKYL",
  description:
    "Стандарты профессионального управления МЖД: прозрачность, ответственность ролей, операционные регламенты и единые формы отчётности в методологии AKYL.",
  keywords: [
    "стандарты управления МЖД",
    "принципы управления ЖКХ",
    "регламенты УК",
    "прозрачность управления домом",
    "ответственность ОСИ и УК",
    "стандарты отчётности МЖД",
    "операционные процедуры ЖКХ",
    "AKYL стандарты",
  ],
} as const;
...
export const IMPLEMENTATION_SEO = {
  title: "Практика внедрения системы управления МЖД | AKYL",
  description:
    "Пошаговое внедрение методологии AKYL: диагностика, аудит, проектирование системы, инструменты, обучение участников и контроль эффективности управления МЖД.",
  keywords: [
    "внедрение управления МЖД",
    "практика внедрения AKYL",
    "диагностика дома ЖКХ",
    "аудит управления МЖД",
    "внедрение KPI и процессов",
    "цифровизация УК",
    "переход к системному управлению домом",
    "пилот внедрения МЖД",
  ],
} as const;
