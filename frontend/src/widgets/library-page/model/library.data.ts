...
export const libraryItems: LibraryItem[] = [
  ...
  },
  {
    id: 2,
    type: "research",
    title: "Бенчмаркинг KPI: многоквартирные дома в Центральной Азии",
    topic: "Системы KPI",
    description:
  ...
  },
  {
    ...
    topic: "Операции",
    description: "Шаблон оценки работы подрядчиков по ключевым показателям.",
    format: "PDF",
    date: "2024-01-25",
  },
  {
    ...
    topic: "Кейсы",
    description: "Результаты исследований опросов в 50 управляемых домах.",
    readTime: "35 мин",
    date: "2024-03-10",
  },
  {
