...
import { akimatSectionMotion } from "../model/akimatMotion";

export function AkimatCtaSection() {
  return (
    <section className="bg-slate-50 py-16 sm:py-20 lg:pb-24">
      <Container>
        <motion.div
        ...
        >
          ...
          <div className="relative max-w-3xl">
            ...
            <h2 className="mt-4 font-[family-name:var(--font-sora)] text-3xl font-semibold tracking-tight sm:text-4xl">
              {akimatCta.title}
            </h2>
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              ...
              >
                <Link href="/consultation">{akimatCta.primaryCta}</Link>
              </Button>
              <Button
                asChild
                variant="secondary"
              ...
              >
                <Link href="/mzhd">{akimatCta.secondaryCta}</Link>
              </Button>
            </div>
          </div>
        </motion.div>
