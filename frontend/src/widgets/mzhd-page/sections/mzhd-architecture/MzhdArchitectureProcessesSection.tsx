...
import { mzhdArchitectureProcessRows } from "@/widgets/mzhd-page";
    ...
    <section className="border-y border-slate-200 bg-slate-50 py-16 sm:py-20">
      <Container>
        ...
        <p className="mt-4 max-w-3xl text-slate-600">
          Архитектура связывает стратегические, операционные и исполнительские
          процессы в единую карту ответственности.
        </p>
