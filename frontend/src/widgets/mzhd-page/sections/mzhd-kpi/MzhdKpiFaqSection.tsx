...
import { mzhdKpiFaq } from "../../model/mzhd-kpi.data";

export function MzhdKpiFaqSection() {
  return (
    <section
      className="py-16 sm:py-20"
      aria-label="Частые вопросы о KPI и эффективности управления МЖД"
      data-geo-faq
    >
      <Container>
        ...
        <h2 className="mt-3 max-w-3xl text-3xl font-semibold tracking-tight sm:text-4xl">
          Частые вопросы о KPI и IEU
        </h2>
        <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
          Краткие ответы о метриках управления домом и индексе эффективности.
        </p>
