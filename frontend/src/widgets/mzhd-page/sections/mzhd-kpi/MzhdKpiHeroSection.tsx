...
import { mzhdKpiHero, mzhdKpiImages } from "@/widgets/mzhd-page";

export function MzhdKpiHeroSection() {
  return (
    <section className="relative min-h-[80vh] overflow-hidden text-white">
      <div className="absolute inset-0">
        <Image
          src={mzhdKpiImages.hero}
          alt={mzhdKpiHero.imageAlt}
          fill
          priority
      ...
      <Container className="relative z-10 flex min-h-[80vh] flex-col justify-center py-20">
        ...
        <p className="mt-6 max-w-2xl text-lg text-white/75">{mzhdKpiHero.description}</p>
