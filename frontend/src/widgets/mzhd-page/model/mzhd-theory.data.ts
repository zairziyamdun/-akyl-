...
export const mzhdTheoryDefinition =
  "Теория управления МЖД в методологии AKYL описывает многоквартирный дом как управляемую социотехническую систему: технический, организационный и социальный слои связаны процессами, финансами, данными и обратной связью, а качество управления измеряется через KPI и индекс эффективности IEU.";
